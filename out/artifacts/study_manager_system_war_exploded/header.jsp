            ...
            <ul class="navbar-nav mr-lg-4 w-100">
                <li class="nav-item nav-search d-none d-lg-block w-100">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="搜索一下" aria-label="search" aria-describedby="search">
                    </div>
                </li>
            </ul>
            <ul class="navbar-nav navbar-nav-right">
                ...
                <c:if test="${null == uname}">
                    <li class="nav-item mr-8">
                        <a type="button" class="btn btn-primary" style="width: 80px" href="login.jsp">登录</a>
                    </li>
                </c:if>
                <c:if test="${null != uname}">
