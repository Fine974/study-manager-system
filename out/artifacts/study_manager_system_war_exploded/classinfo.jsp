            ...
            <div class="d-flex justify-content-between flex-wrap">
              <div class="d-flex align-items-end flex-wrap">
                ...
                <div class="d-flex">
                  ...
                  <p class="text-primary mb-0 hover-cursor">班级信息管理</p>
                </div>
              </div>
                        ...
                        <div class="card-body">
                          <form class="forms-sample">
                            <div class="form-group row">
                              <label for="sname" class="col-sm-3 col-form-label">班级名</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="sname" placeholder="请输入班级名">
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="sdept" class="col-sm-3 col-form-label">所属院系</label>
                              <div class="col-sm-9">
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                  <table id="" class="table text-center table-hover">
                    <thead>
                    <tr>
                      <th>班级名</th>
                      <th>所属院系</th>
